...
<div class="container">
    <div class="row align-content-center">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="/spots/${spot.id}/sector/add" class="btn btn-outline-primary btn-block " role="button" aria-pressed="true">
    ...
    <div class="row">
        <div class="col-lg-8 offset-2">
            <a href="/spots" class="btn btn-outline-primary btn-block active" role="button" aria-pressed="true">
