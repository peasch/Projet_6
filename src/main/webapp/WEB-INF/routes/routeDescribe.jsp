    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 ">
                <article style="background-image: url('/photos/escalade_2.jpg');float:left;height:300px">
                    <div class="overlay">
                        <h4><a href="/spots/${spot.id}"> Secteur ${sector.name}<br>du spot :<br>${ spot.name }<span class="red-dot">.</span></a></h4>
...
<section class="testage">
    <div class="container">
        <div class="heading">
            <h2>Longueurs de la voie<span class="red-dot">:</span></h2>
            <div class="white-divider"></div>
        </div>
        <div class="row" style="justify-content: center">
            <c:forEach var="length" items="${ lengthes }">
                <div class="col-4 col-md-3 col-lg-2">
                    <h4>${length.routeLengthId}</h4><br>
                    <p><small>${ length.distance} mètres, cotation :</small> ${length.rating}</p>
                </div>
            </c:forEach>

        </div>
        <a href="/route/${route.id}/length/add" class="btn btn-outline-light" role="button"
           aria-pressed="true">Ajouter une longueur</a>
    </div>
</section>
<section id="steps" style="text-align: center">
    <div style="margin: 30px auto">
        <div class="black-divider" style="margin: 20px auto"></div>
        <a href="/spots/${sector.id}" class="btn btn-outline-dark" role="button" aria-pressed="true">
            revenir au spot </a>
