...
<section id="accueil-image">
    <div class="wrapper">
        <h4>Le topo est à nouveau visible pour les utilisateurs<span class="red-dot">.</span>
           <strong> Ils pourront en faire une demande de réservation</strong><span class="red-dot">.</span></h4>
        <div class="clear"></div>
    </div>
</section>
