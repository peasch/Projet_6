    ...
    <div class="row" style="margin:0 0 ">
        <div class="col-lg-8 offset-2">
            <form method="post" action="/spots/added" style="margin-top: 20px">
                ...
                <legend><u> Saisissez les informations du spot :</u></legend>
              ...
              <input type="radio">Autre : <br><input type="text" name="country" id="country" placeholder="pays..."style="margin-left: 10px"/><br>
                ...
                <input type="text" name="latitude" id="latitude"placeholder="latitude..." style="margin-left: 10px"/><br>

                <label for="longitude"><u>Quel est sa longitude ?</u></label><br>
                <input type="text" name="longitude" id="longitude"placeholder="longitude..." style="margin-left: 10px"/><br>
